...
const InteractiveMap = dynamic(
  () => import("@/components/home/interactive-map").then((mod) => mod.InteractiveMap),
  {
    ssr: false,
    loading: () => (
      <div className="h-[320px] sm:h-[450px] w-full bg-slate-100 animate-pulse rounded-2xl border border-slate-200 flex items-center justify-center text-slate-500 font-semibold text-sm">
...
export function HeroSearch() {
  ...
  return (
    <section className="relative pt-20 sm:pt-24 pb-8 sm:pb-12 bg-white text-slate-900">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 w-full space-y-6 sm:space-y-8">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl p-4 sm:p-7 shadow-xl border border-slate-200">
          <form onSubmit={handleSearch} className="space-y-4">
            ...
            {/* Inputs Grid */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5 sm:gap-3 items-end">
              {/* FROM DISTRICT */}

  ...
  const stats = [
    {
      icon: Building2,
      value: "50+",
      labelEn: "Verified Operators",
      labelBn: "ভেরিফাইড অপারেটর",
      color: "text-teal-600",
    },
    {
      icon: MapPin,
      value: "500+",
      labelEn: "Inter-District Routes",
      labelBn: "আন্তঃজেলা রুট",
      color: "text-emerald-600",
    },
    {
      icon: Bus,
      value: "1,200+",
      labelEn: "Daily Bus Trips",
    ...
    },
    {
      icon: Users,
      value: "10,000+",
      labelEn: "Daily Passengers",
      labelBn: "দৈনিক যাত্রী সেবা",
      color: "text-emerald-600",
    },
  ];
